...
QAQCMRE_CruiseSampleMetadata_WCOA21 %>% 
  ...
  left_join(bottle_Data_w_arag_ctd, by = c("Cast" = "btl_Sample_ID", "Bottle" = "btl_Rosette_Position")) %>%
  left_join(sean_selected, by = c("Sample_Name" = "Sample Name")) -> WCOA21_sample_data
