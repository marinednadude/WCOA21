...
WCOA21_sample_data_with_rep_chem_bottle_info <- WCOA21_sample_data %>%
  left_join(
    sean_selected %>% select(
      `Sample Name`, `Rep Chem Bottle`, rep_station, rep_cast, rep_bottle
    ),
    by = c("Sample_Name" = "Sample Name")
  )

# # SAve as CSV so Brynn can use in python chunk below to finish merging to figure out rep_chem_bottle chaos
# write.csv(WCOA21_sample_data_with_rep_chem_bottle_info, "/Users/zalmanek/Development/WCOA21/wcoa21_data_management/brynn_rep_chem_bottle/pre_rep_chem_merged_data.csv", row.names = FALSE)
...
write.csv(WCOA21_sample_data_merged_with_bottle_rep, "/Users/zalmanek/Development/WCOA21/wcoa21_data_management/brynn_rep_chem_bottle/pre_rep_chem_merged_data_with_rep.csv", row.names = FALSE)
# 
